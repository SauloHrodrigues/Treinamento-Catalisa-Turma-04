...
public class MainLista06_A {
    public static void main(String[] args) {
        ...
        while (repetirOperacao) {
            int opcaoSelecionada = menuInicial(input);
            switch (opcaoSelecionada) {
                case 0:
                    repetirOperacao = false;
                    break;
                case 1:
                    cadastroProfessores(input);
                    break;
    ...
    private static int menuInicial(Scanner input) {
        //todo implementar
        System.out.println("************** FUNCIONÁRIOS ****************");
        System.out.println("---------------------------------------");
        System.out.println("| 1 - Cadasatro de Professores:      |");
    ...
    public static void cadastroProfessores(Scanner input){
